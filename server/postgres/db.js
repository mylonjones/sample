...
// client.query(`INSERT INTO days (user_id, date) VALUES (1 , '2022-3-7')`)
//   .then(() => console.log('created day for mylon'))
//   .catch(e => console.log(e))


// pool.query(deleteCalories)
//   .then(() => console.log('deleted calories'))
//   .catch(e => console.log(e))
//   .then(() => {
//     pool.query(deleteDays)
//       .then(() => console.log('deleted days'))
//       .catch(e => console.log(e))
//       .then(() => {
...
//               .catch(e => console.log(e))
//               .then(() => {
//                 pool.query(createDays)
//                   .then(() => console.log('created days'))
//                   .catch(e => console.log(e))
//                   .then(() => {
//                     pool.query(createCalories)
//                       .then(() => console.log('created calories'))
//                       .catch(e => console.log(e))
//                       .then(() => {
//                         pool.end()
